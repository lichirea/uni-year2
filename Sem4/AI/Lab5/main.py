...
class Mecanism():
    def __init__(self):
        ...
        # fizica obiectului
        self.M = 2 # mass of the cart in kg
        self.m = 0.1 # mass of the pendulum in kg
        self.b = 1.2 # coeficient of friction for the cart
        self.bp = 0.01 # coeficient of friction for the pendulum
        self.l = 1  # length to pendulum center of the mass
        self.I = 0.0006 # mass momentum of inertia for the pendulum
        self.F = 0   # force applied to the cart
        self.x = -0.5   # cart position coordinate
        self.theta = 0.23 * pi # pendulum angle from vertical (down) in radians
        self.dx = 0.2  # first derivative of x is zero (no speed)
